...
%% list as described in <a href="http://yaws.hyber.org/embed.yaws">the Yaws
%% reference manual</a>. The setting is expanded using {@}, which means that
%% e.g. the "variables" `$PRIV_DIR', `$LIB_DIR', `$HOME', etc. can be used.
%% @end
add_http_session() ->
