...
Equivalent to [`queue_notification(Module, Method, Elems,get_device_id(Env))`](#queue_notification-4).<a name="queue_notification-5"></a>
...
as soon as possible.<a name="queue_reverse_request-4"></a>
